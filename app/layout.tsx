...
export const metadata: Metadata = {
	title: 'Chirag Kuinkel - Frontend Developer',
	description:
	...
	authors: [{ name: 'Chirag Kuinkel' }],
	creator: 'Chirag Kuinkel',
	openGraph: {
		title: 'Chirag Kuinkel- Frontend Developer Portfolio',
		...
		siteName: 'Chirag Kuinkel - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
